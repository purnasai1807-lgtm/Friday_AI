...
The default path is `~/.friday/audit.db`, configurable via `security.audit_log_path` in `config.toml`.
...
- [API Reference: Security](../api-reference/friday/security/index.md) — complete class and function signatures
