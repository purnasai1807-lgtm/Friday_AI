---
title: Downloads
description: Download the Friday desktop app, browser app, CLI, or Python SDK
---
...
!!! info "Backend required"
    ...
    ```bash
    git clone https://github.com/purnasai1807-lgtm/Friday_AI.git && cd Friday
...
|----------|----------|-------|
| macOS (Apple Silicon) | [:material-download: **Friday.dmg**](https://github.com/purnasai1807-lgtm/Friday_AI/releases/download/desktop-latest/Friday_0.1.0_aarch64.dmg) | M1/M2/M3/M4 Macs |
| Windows (64-bit) | [:material-download: **Friday-setup.exe**](https://github.com/purnasai1807-lgtm/Friday_AI/releases/download/desktop-latest/Friday_0.1.0_x64-setup.exe) | Windows 10+ |
| Linux (DEB) | [:material-download: **Friday.deb**](https://github.com/purnasai1807-lgtm/Friday_AI/releases/download/desktop-latest/Friday_0.1.0_amd64.deb) | Ubuntu, Debian |
| Linux (RPM) | [:material-download: **Friday.rpm**](https://github.com/purnasai1807-lgtm/Friday_AI/releases/download/desktop-latest/Friday-0.1.0-1.x86_64.rpm) | Fedora, RHEL |
| Linux (AppImage) | [:material-download: **Friday.AppImage**](https://github.com/purnasai1807-lgtm/Friday_AI/releases/download/desktop-latest/Friday_0.1.0_amd64.AppImage) | Any distro |
...
by Apple. If you see **"Friday is damaged and can't be opened"**, run this in
