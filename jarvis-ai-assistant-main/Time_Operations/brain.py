...
def input_manage(input_text):
        ...
        if output != "No valid time found in input":
            save_to_file(output, time, r'C:\Users\chatu\OneDrive\Desktop\Friday AI\schedule.txt')
...
def input_manage_Alam(input_text):
        ...
        if time != "No valid time found in input":
            save_to_Alarmfile(time, r'C:\Users\chatu\OneDrive\Desktop\Friday AI\Alam_data.txt')
            print("Schedule_Data_Saved")
        else:
            print("pass")
