...
class Friday AIUI(QWidget):
    ...
    def init_ui(self):
        self.setWindowTitle('Friday AI UI')
    ...
    def run_main_file(self):
        try:
            ...
            path_to_main_py = os.path.join(current_directory, r"C:\Users\chatu\OneDrive\Desktop\Friday AI\MAIN\main.py")
