#!/usr/bin/env python3
"""Index Friday docs (README.md + docs/**/*.md) into a DenseMemory backend.
...
def build_index(
    ...
    *,
    ...
    dedupe: bool = True,
    # Empirical: on the actual Friday docs the boilerplate that
    # crowds retrieval ("Friday runs entirely on your hardware...")
...
def main() -> int:
    ...
    queries = args.query or [
        ...
        "what inference engines does friday support?",
