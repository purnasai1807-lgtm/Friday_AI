...
uv run maturin develop -m rust/crates/friday-python/Cargo.toml --quiet 2>/dev/null \
...
uv run friday serve --port 8000 &>/dev/null &
CLEANUP_PIDS+=($!)
sleep 3
...
echo ""
echo -e "${GREEN}${BOLD}  Friday is running!${NC}"
echo ""
