...
use friday_core::{GenerateResult, Message, Role};
use serde_json::Value;
use std::pin::Pin;
use tokio_stream::Stream;

pub type StreamItem = Result<String, friday_core::FridayError>;
...
pub trait InferenceEngine: Send + Sync {
    ...
    fn generate(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<GenerateResult, friday_core::FridayError>;
    ...
    async fn stream(
        ...
        max_tokens: i64,
        extra: Option<&Value>,
    ) -> Result<TokenStream, friday_core::FridayError>;

    fn list_models(&self) -> Result<Vec<String>, friday_core::FridayError>;
...
mod tests {
    use super::*;
    use friday_core::{Message, ToolCall};
