...
impl PyMessage {
    pub fn to_core(&self) -> friday_core::Message {
        let role = match self.role.as_str() {
            "system" => friday_core::Role::System,
            "assistant" => friday_core::Role::Assistant,
            "tool" => friday_core::Role::Tool,
            _ => friday_core::Role::User,
        };
        friday_core::Message {
            role,
...
#[pyclass(name = "Config")]
pub struct PyConfig {
    pub inner: friday_core::FridayConfig,
}
...
impl PyConfig {
    ...
    fn new() -> Self {
        Self {
            inner: friday_core::FridayConfig::default(),
        }
    }
...
pub struct PyEventBus {
    pub inner: std::sync::Arc<friday_core::EventBus>,
}
...
impl PyEventBus {
    ...
    fn new() -> Self {
        Self {
            inner: std::sync::Arc::new(friday_core::EventBus::new(true)),
        }
    }
