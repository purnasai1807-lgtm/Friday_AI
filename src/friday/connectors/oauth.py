...
class OAuthProvider:
    ...
    # Filenames in ~/.friday/connectors/ to save tokens to
...
def get_client_credentials(
    ...
    Checks credential files in ``~/.friday/connectors/`` and falls
        ...
        def do_GET(self) -> None:  # noqa: N802 — required override name
            ...
            if "code" in params:
                ...
                self.wfile.write(
                    ...
                    b"<p>You can close this tab and return to Friday.</p>"
                    b"</body></html>"
                )
