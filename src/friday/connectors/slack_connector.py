...
Uses OAuth tokens stored locally (see :mod:`friday.connectors.oauth`).
...
from friday.connectors._stubs import BaseConnector, Document, SyncStatus
from friday.connectors.oauth import delete_tokens, load_tokens, save_tokens
