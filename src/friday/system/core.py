"""FridaySystem — the fully wired system dataclass."""
...
if TYPE_CHECKING:
    ...
    from friday.channels._stubs import BaseChannel
    from friday.learning._stubs import RouterPolicy
    ...
    from friday.security.boundary import BoundaryGuard
    ...
    from friday.speech._stubs import SpeechBackend
...
class FridaySystem:
    ...
    def wire_channel(self, channel_bridge: Any) -> None:
        ...
        ----------
        channel_bridge:
            A connected :class:`~friday.channels._stubs.BaseChannel`
    ...
    def __enter__(self) -> FridaySystem:
        return self
