...
if TYPE_CHECKING:
    from friday.evals.core.types import EvalSuiteConfig
    from friday.operators.types import OperatorManifest
    from friday.recipes.loader import Recipe
...
def recipe_to_eval_suite(
    ...
    backend = recipe.eval_backend or ("friday-agent" if has_agent else "friday-direct")
