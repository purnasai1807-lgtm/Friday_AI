...
Adapted from IPW's ``environment.py``.  Uses Friday's
:class:`~friday.tools._stubs.ToolExecutor` for real tool dispatch
...
class OrchestratorEnvironment:
    """RL environment that executes tools via Friday ``ToolExecutor``.
