...
``~/.friday/learning/skills/<skill-name>/optimized.toml``.
...
from friday.core.types import Trace, TraceStep
...
class SkillOptimizer:
    ...
    def _run_dspy(
        ...
        """
        from friday.core.config import DSPyOptimizerConfig
        from friday.learning.agents.dspy_optimizer import DSPyAgentOptimizer
    ...
    def _run_gepa(
        ...
        from friday.learning.agents.gepa_optimizer import GEPAAgentOptimizer
