"""LLM-based optimizer for Friday configuration tuning.

Uses a cloud LLM to propose optimal Friday configs, inspired by DSPy's
...
from friday.core.types import Trace
...
class LLMOptimizer:
    """Uses a cloud LLM to propose optimal Friday configs.
    ...
    def _build_initial_prompt(self) -> str:
        ...
        lines: List[str] = []
        lines.append("You are optimizing an Friday AI system configuration.")
        lines.append("")
    ...
    def _build_analyze_prompt(
        ...
        lines: List[str] = []
        lines.append("Analyze this Friday evaluation result.")
        lines.append("")
