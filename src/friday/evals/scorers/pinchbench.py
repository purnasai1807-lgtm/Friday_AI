...
Provides transcript translation (Friday events → PinchBench format),
...
from friday.evals.core.event_recorder import EventType
from friday.evals.core.scorer import LLMJudgeScorer
from friday.evals.core.types import EvalRecord

LOGGER = logging.getLogger(__name__)

# ---------------------------------------------------------------------------
# Tool name mapping: Friday name → PinchBench-expected name
# ---------------------------------------------------------------------------
...
def _tool_results_to_transcript(
    ...
    """Build transcript from FridayAgentBackend tool_results list."""
    transcript: List[Dict[str, Any]] = []
