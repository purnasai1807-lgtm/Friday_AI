...
from friday.evals.core.backend import InferenceBackend
from friday.evals.core.dataset import DatasetProvider
from friday.evals.core.export import _hardware_info_dict
from friday.evals.core.scorer import Scorer
from friday.evals.core.tracker import ResultTracker
...
try:
    from friday.telemetry.efficiency import compute_efficiency
except ImportError:  # pragma: no cover
    compute_efficiency = None  # type: ignore[assignment]

try:
    from friday.telemetry.efficiency import estimate_model_flops_per_token
except ImportError:  # pragma: no cover
...
class EvalRunner:
    ...
    def run(
        ...
        from friday.evals.core.dataset import DatasetProvider as _DP
