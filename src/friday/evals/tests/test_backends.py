...
class TestFridayDirectBackend:
    ...
    def test_construction_default(self, mock_builder_cls):
        ...
        backend = FridayDirectBackend()
        assert backend.backend_id == "friday-direct"
    ...
    def test_construction_with_engine_key(self, mock_builder_cls):
        ...
        FridayDirectBackend(engine_key="cloud")
...
class TestFridayAgentBackend:
    ...
    def test_construction(self, mock_builder_cls):
        ...
        assert backend.backend_id == "friday-agent"
        mock_builder.engine.assert_called_with("cloud")
    ...
    def test_generate_full(self, mock_builder_cls):
        ...
        backend = FridayAgentBackend(agent_name="orchestrator")
