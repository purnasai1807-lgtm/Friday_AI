"""``friday chat`` — interactive multi-turn chat REPL."""
...
def chat(
    ...
    # Resolve engine
    from friday.engine import get_engine
    from friday.intelligence import register_builtin_models
    ...
    if agent_key and agent_key != "none":
        try:
            import friday.agents  # noqa: F401 — trigger registration
    ...
    # Print banner
    console.print(
        f"[green bold]Friday Chat[/green bold]\n"
