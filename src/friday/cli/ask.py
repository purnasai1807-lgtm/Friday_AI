"""``friday ask`` — send a query to the assistant."""
...
from friday.cli._tool_names import resolve_tool_names
from friday.cli.hints import hint_no_engine
...
def ask(
    ...
    if resolved is None:
        console.print(
            ...
            "  [cyan]friday config set engine.ollama.host http://<remote-ip>:11434[/cyan]\n"
