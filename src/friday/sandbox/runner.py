...
from friday.agents._stubs import AgentContext, AgentResult, BaseAgent
...
class ContainerRunner:
    ...
    ----------
    image:
        Docker image to run.  Defaults to ``friday-sandbox:latest``.
    timeout:
    ...
    DEFAULT_IMAGE = "friday-sandbox:latest"
    DEFAULT_TIMEOUT = 300
