...
def create_energy_monitor(
    ...
    try:
        from friday.telemetry.energy_nvidia import NvidiaEnergyMonitor
    ...
    try:
        from friday.telemetry.energy_amd import AmdEnergyMonitor
    ...
    try:
        from friday.telemetry.energy_apple import AppleEnergyMonitor
    ...
    try:
        from friday.telemetry.energy_rapl import RaplEnergyMonitor
