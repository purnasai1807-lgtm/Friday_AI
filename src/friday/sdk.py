"""High-level Python SDK for Friday."""
...
from friday.system import FridaySystem, SystemBuilder
from friday.telemetry.instrumented_engine import InstrumentedEngine
...
class MemoryHandle:
    ...
    def _get_backend(self) -> Any:
        ...
        import friday.tools.storage  # noqa: F401
        ...
        if not MemoryRegistry.contains(key):
            ...
            try:
                from friday.tools.storage.sqlite import SQLiteMemory  # noqa: F401
            except ImportError:
                pass
    ...
    def index(
        ...
        *,
        ...
        from friday.tools.storage.chunking import ChunkConfig
        from friday.tools.storage.ingest import ingest_path
...
class Friday:
    ...
    @property
    def config(self) -> FridayConfig:
        """Return the active configuration."""
        return self._config

    @property
    def version(self) -> str:
        """Return the Friday version string."""
        return friday.__version__
    ...
    def _ensure_engine(self) -> None:
        ...
        try:
            import friday.engine  # noqa: F401
        except ImportError:
            pass
    ...
    def _run_agent(
        ...
        *,
        ...
        import friday.agents  # noqa: F401
        from friday.agents._stubs import AgentContext
        ...
        if agent_name == "morning_digest" and hasattr(self._config, "digest"):
            ...
            from friday.tools.digest_collect import DigestCollectTool
            from friday.tools.text_to_speech import TextToSpeechTool
        ...
        if context and self._config.agent.context_from_memory:
            try:
                from friday.cli.ask import _get_memory_backend
                from friday.tools.storage.context import (
                    ContextConfig,
                    inject_context,
                )
...
__all__ = ["Friday", "FridaySystem", "MemoryHandle", "SystemBuilder"]
