...
def _load_persona(persona_name: str) -> str:
    ...
    search_paths = [
        Path("configs/friday/prompts/personas") / f"{persona_name}.md",
        Path.home() / ".friday" / "prompts" / "personas" / f"{persona_name}.md",
    ]
...
class MorningDigestAgent(ToolUsingAgent):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self._persona = kwargs.pop("persona", "friday")
    ...
    def run(
        ...
        **kwargs: Any,
        ...
        evaluator_feedback = ""
        try:
            from friday.agents.digest_evaluator import DigestEvaluator
