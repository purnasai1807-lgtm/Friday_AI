...
Routes incoming :class:`~friday.channels._stubs.ChannelMessage` objects
...
from friday.channels._stubs import BaseChannel, ChannelMessage
...
_ESCALATION_TEMPLATE = "{preview}...\n\n---\nFull report ready — open in Friday:\nfriday://research/{session_id}"
...
class ChannelAgent:
    ...
    agent:
        ...
        method (typically a :class:`~friday.agents._stubs.BaseAgent`
        subclass).
    max_workers:
