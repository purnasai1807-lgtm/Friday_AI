...
from friday.core.registry import SpeechRegistry
from friday.speech._stubs import TranscriptionResult
from friday.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_transcribe():
    ...
    with patch("friday.speech.openai_whisper.OpenAI", return_value=mock_client):
        from friday.speech.openai_whisper import OpenAIWhisperBackend
...
def test_openai_whisper_health():
    with patch("friday.speech.openai_whisper.OpenAI"):
        from friday.speech.openai_whisper import OpenAIWhisperBackend
