...
from friday.speech.faster_whisper import FasterWhisperBackend
...
def test_faster_whisper_transcribe():
    ...
    with patch(
        "friday.speech.faster_whisper.WhisperModel",
...
def test_faster_whisper_supported_formats():
    ...
    with patch("friday.speech.faster_whisper.WhisperModel"):
        from friday.speech.faster_whisper import FasterWhisperBackend
