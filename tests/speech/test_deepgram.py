...
from friday.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_transcribe():
    ...
    with patch("friday.speech.deepgram.DeepgramClient", return_value=mock_client):
        from friday.speech.deepgram import DeepgramSpeechBackend
...
def test_deepgram_health():
    with patch("friday.speech.deepgram.DeepgramClient"):
        from friday.speech.deepgram import DeepgramSpeechBackend
