...
class TestDefaults:
    def test_friday_config_defaults(self) -> None:
        cfg = FridayConfig()
...
class TestSecurityConfig:
    ...
    def test_security_config_on_friday_config(self) -> None:
        cfg = FridayConfig()
...
class TestChannelConfig:
    ...
    def test_channel_config_on_friday_config(self) -> None:
        cfg = FridayConfig()
...
class TestSandboxConfig:
    def test_defaults(self) -> None:
        ...
        assert sc.image == "friday-sandbox:latest"
    ...
    def test_on_friday_config(self) -> None:
        cfg = FridayConfig()
...
class TestApplyTomlSectionListNormalization:
    def test_apply_toml_section_list_to_str_field(self) -> None:
        ...
        from friday.core.config import ToolsConfig, _apply_toml_section
    ...
    def test_apply_toml_section_list_to_property_setter(self) -> None:
        ...
        from friday.core.config import _apply_toml_section
...
class TestWhatsAppBaileysChannelConfig:
    def test_defaults(self) -> None:
        ...
        assert wc.auth_dir == ""
        assert wc.assistant_name == "Friday"
