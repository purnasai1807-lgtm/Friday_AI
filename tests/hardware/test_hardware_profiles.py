...
class TestDetectHardware:
    ...
    @patch("friday.core.config.shutil.which", return_value="/usr/bin/nvidia-smi")
    @patch(
        "friday.core.config._run_cmd",
    ...
    @patch("friday.core.config.shutil.which", return_value="/usr/bin/rocm-smi")
    @patch(
        "friday.core.config._run_cmd",
        side_effect=[
    ...
    @patch("friday.core.config.platform.system", return_value="Darwin")
    @patch(
        "friday.core.config._run_cmd",
        return_value=(
            "Graphics/Displays:\n"
    ...
    @patch("friday.core.config.shutil.which", return_value=None)
    @patch("friday.core.config.platform.system", return_value="Linux")
