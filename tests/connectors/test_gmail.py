...
def connector(tmp_path: Path):
    ...
    from friday.connectors.gmail import GmailConnector  # noqa: PLC0415
...
@patch("friday.connectors.gmail._gmail_api_list_messages")
@patch("friday.connectors.gmail._gmail_api_get_message")
