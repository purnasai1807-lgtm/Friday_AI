...
def connector(tmp_path: Path):
    ...
    from friday.connectors.dropbox import DropboxConnector  # noqa: PLC0415
...
@patch("friday.connectors.dropbox._dropbox_api_list_folder")
@patch("friday.connectors.dropbox._dropbox_api_download")
