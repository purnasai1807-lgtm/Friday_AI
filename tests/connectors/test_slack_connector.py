...
def connector(tmp_path: Path):
    ...
    from friday.connectors.slack_connector import SlackConnector  # noqa: PLC0415
...
@patch("friday.connectors.slack_connector._slack_api_conversations_list")
@patch("friday.connectors.slack_connector._slack_api_conversations_history")
@patch("friday.connectors.slack_connector._slack_api_users_list")
