...
def connector(tmp_path: Path):
    ...
    from friday.connectors.gdrive import GDriveConnector  # noqa: PLC0415
...
@patch("friday.connectors.gdrive._gdrive_api_list_files")
@patch("friday.connectors.gdrive._gdrive_api_export")
