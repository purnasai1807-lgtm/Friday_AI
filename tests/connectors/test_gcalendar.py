...
def connector(tmp_path: Path):
    ...
    from friday.connectors.gcalendar import GCalendarConnector  # noqa: PLC0415

    creds_path = str(tmp_path / "gcalendar.json")
    with patch(
        "friday.connectors.oauth._SHARED_GOOGLE_CREDENTIALS_PATH",
...
@patch("friday.connectors.gcalendar._gcal_api_calendars_list")
@patch("friday.connectors.gcalendar._gcal_api_events_list")
