...
def connector(tmp_path: Path):
    ...
    from friday.connectors.granola import GranolaConnector  # noqa: PLC0415
...
@patch("friday.connectors.granola._granola_api_list_notes")
@patch("friday.connectors.granola._granola_api_get_note")
...
def test_format_note_content() -> None:
    ...
    from friday.connectors.granola import _format_note_content  # noqa: PLC0415
