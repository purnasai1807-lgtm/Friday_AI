...
def connector(tmp_path: Path):
    ...
    from friday.connectors.notion import NotionConnector  # noqa: PLC0415
...
@patch("friday.connectors.notion._notion_api_search")
@patch("friday.connectors.notion._notion_api_get_blocks")
...
def test_render_blocks_to_markdown() -> None:
    ...
    from friday.connectors.notion import _render_blocks_to_markdown  # noqa: PLC0415
