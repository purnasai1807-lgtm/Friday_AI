...
_LOCAL_CONNECTORS = [
    ("apple_notes", "friday.connectors.apple_notes", "AppleNotesConnector"),
    ("imessage", "friday.connectors.imessage", "IMessageConnector"),
]

_TOKEN_CONNECTORS = [
    ("gmail_imap", "friday.connectors.gmail_imap", "GmailIMAPConnector"),
    ("outlook", "friday.connectors.outlook", "OutlookConnector"),
    ("slack", "friday.connectors.slack_connector", "SlackConnector"),
    ("notion", "friday.connectors.notion", "NotionConnector"),
    ("granola", "friday.connectors.granola", "GranolaConnector"),
    ("gdrive", "friday.connectors.gdrive", "GDriveConnector"),
    ("gcalendar", "friday.connectors.gcalendar", "GCalendarConnector"),
    ("gcontacts", "friday.connectors.gcontacts", "GContactsConnector"),
    ("dropbox", "friday.connectors.dropbox", "DropboxConnector"),
]
