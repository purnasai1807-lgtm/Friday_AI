...
from friday.bench.energy import EnergyBenchmark
from friday.core.registry import BenchmarkRegistry
from friday.telemetry.energy_monitor import EnergySample


@pytest.fixture(autouse=True)
def _register_energy():
    """Re-register energy benchmark after registry clear."""
    from friday.bench.energy import ensure_registered
