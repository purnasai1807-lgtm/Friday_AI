...
- FridayDirectBackend propagates gpu_metrics flag
...
from friday.evals.core.types import EvalResult, RunConfig, RunSummary
...
class TestSummaryToDict:
    ...
    def test_telemetry_summary_present(self):
        from friday.evals.core.runner import _summary_to_dict
...
class TestResultToTraceDict:
    ...
    def test_estimated_flops_in_trace(self):
        from friday.evals.core.runner import _result_to_trace_dict
...
# ---------------------------------------------------------------------------
# FridayDirectBackend gpu_metrics propagation
# ---------------------------------------------------------------------------


class TestDirectBackendGpuMetrics:
    """Verify FridayDirectBackend sets gpu_metrics on config."""

    @patch("friday.system.SystemBuilder")
...
class TestTauBenchTelemetryPassthrough:
    ...
    @patch("friday.evals.execution.taubench_env.TauBenchTaskEnv")
...
class TestExpandSuiteModelMetadata:
    ...
    def test_metadata_includes_params(self):
        from friday.evals.core.config import expand_suite
        from friday.evals.core.types import (
            BenchmarkConfig,
            DefaultsConfig,
            EvalSuiteConfig,
            ExecutionConfig,
