...
from friday.evals.core.event_recorder import AgentEvent, EventType
from friday.evals.core.trace import TurnTrace
...
def test_events_to_transcript_tool_call_pair():
    ...
    from friday.evals.scorers.pinchbench import events_to_transcript
...
def test_events_to_transcript_tool_name_mapping():
    """Friday tool names are mapped to PinchBench-expected names."""
    from friday.evals.scorers.pinchbench import events_to_transcript
