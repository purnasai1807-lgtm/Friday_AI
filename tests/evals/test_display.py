"""Tests for the Rich display helpers in friday.evals.core.display."""
...
from friday.evals.core.types import MetricStats, RunSummary
...
class TestPrintBanner:
    def test_produces_output(self):
        ...
        output = buf.getvalue()
        assert "Friday" in output or "___" in output
