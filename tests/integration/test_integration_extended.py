...
class TestOpenHandsPipeline:
    ...
    def test_openhands_code_execution_e2e(self):
        _register_all()
        from friday.agents.native_openhands import NativeOpenHandsAgent
        from friday.tools.code_interpreter import (
            CodeInterpreterTool,
        )
...
class TestMCPIntegration:
    ...
    def test_mcp_server_with_all_tools(self):
        ...
        from friday.mcp.transport import InProcessTransport
        from friday.tools.calculator import CalculatorTool
        from friday.tools.think import ThinkTool
    ...
    def test_mcp_unknown_tool_error(self):
        from friday.mcp.client import MCPClient
        from friday.mcp.protocol import MCPError
        from friday.mcp.server import MCPServer
        from friday.mcp.transport import InProcessTransport
        from friday.tools.calculator import CalculatorTool
...
class TestModelCatalogIntegration:
    ...
    def test_all_models_routable(self):
        ...
        from friday.intelligence.model_catalog import (
            BUILTIN_MODELS,
        )
