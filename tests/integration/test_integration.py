...
from friday.core.registry import AgentRegistry, RouterPolicyRegistry, ToolRegistry
...
class TestToolExecutorIntegration:
    ...
    def test_calculator_and_think(self):
        _register_tools()
        from friday.tools._stubs import ToolExecutor
        from friday.tools.calculator import CalculatorTool
        from friday.tools.think import ThinkTool
...
class TestHeuristicRewardWithTelemetry:
    ...
    def test_reward_from_telemetry_record(self):
        from friday.learning._stubs import RoutingContext
...
class TestRouterPolicyRegistryDiscovery:
    ...
    def test_both_policies_registered(self):
        from friday.learning import ensure_registered
...
class TestTelemetryPipeline:
    ...
    def test_store_then_aggregate(self, tmp_path):
        ...
        from friday.telemetry.aggregator import TelemetryAggregator
...
class TestAskFlowWithRouterPolicy:
    ...
    def test_mocked_ask_with_registry_router(self):
        from friday.learning._stubs import RoutingContext
        from friday.learning.routing.heuristic_policy import ensure_registered
        from friday.learning.routing.router import HeuristicRouter
...
class TestSDKImport:
    """Verify Friday class is importable from friday."""

    def test_friday_imports(self):
...
class TestSDKAskFlow:
    ...
    def test_sdk_ask_e2e(self):
        ...
        from friday.sdk import Friday

        engine = _make_engine("SDK response")
        with patch("friday.sdk.get_engine", return_value=("mock", engine)):
            j = Friday(config=FridayConfig(), model="test-model")
...
class TestSDKMemoryHandle:
    ...
    def test_index_and_search(self, tmp_path):
        from friday.core.config import FridayConfig
        from friday.sdk import MemoryHandle
...
class TestBenchmarkRegistryDiscovery:
    ...
    def test_discovers_benchmarks(self):
        from friday.bench import ensure_registered
...
class TestBenchmarkSuiteRunAll:
    ...
    def test_suite_produces_jsonl(self):
        ...
        from friday.bench import ensure_registered
        from friday.bench._stubs import BenchmarkSuite
        from friday.core.registry import BenchmarkRegistry
...
class TestFullPipeline:
    ...
    def test_full_pipeline(self, tmp_path):
        ...
        from friday.agents._stubs import AgentResult
        from friday.core.config import FridayConfig
        ...
        with patch("friday.sdk.get_engine", return_value=("mock", engine)):
            j = Friday(config=cfg, model="test-model")
