...
from friday.core.registry import CompressionRegistry
...
def _register_compressors():
    ...
    from friday.sessions.compression import (
        ModelSummarization,
...
def test_rule_based_strips_tool_boilerplate():
    from friday.sessions.compression import RuleBasedPrecompression
...
def test_session_consolidation_preserves_recent():
    from friday.sessions.compression import SessionConsolidation
...
def test_tiered_summaries_gradient():
    from friday.sessions.compression import TieredSummaries
