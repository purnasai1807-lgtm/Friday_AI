...
pytest.importorskip("fastapi", reason="friday[server] not installed")

from friday.channels._stubs import (
    BaseChannel,
    ChannelHandler,
    ChannelStatus,
)
...
def mock_system():
    system = MagicMock()
    system.ask.return_value = {"content": "Hello from Friday!"}
    return system
...
class TestChatRouting:
    def test_routes_to_system_ask(self, bridge, mock_system):
        ...
        assert reply == "Hello from Friday!"
