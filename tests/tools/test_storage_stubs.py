...
class TestStorageStubs:
    ...
    def test_backward_compat_import(self) -> None:
        ...
        from friday.tools.storage._stubs import MemoryBackend as MB
        from friday.tools.storage._stubs import RetrievalResult as RR
    ...
    def test_sqlite_backward_compat(self) -> None:
        ...
        from friday.tools.storage.sqlite import SQLiteMemory as S1
