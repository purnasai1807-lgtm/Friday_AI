...
from friday.core.config import CapabilitiesConfig, FridayConfig, SecurityConfig
from friday.core.events import EventBus
from friday.security import SecurityContext, setup_security
...
def _make_config(*, enabled: bool = True, caps_enabled: bool = False) -> FridayConfig:
    cfg = FridayConfig()
