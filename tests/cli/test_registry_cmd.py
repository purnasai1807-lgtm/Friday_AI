"""Tests for the ``friday registry`` CLI commands."""
...
class TestRegistryCmd:
    """Test cases for the friday registry CLI group."""
    ...
    def test_registry_show_handles_exception(self) -> None:
        ...
        with patch(
            "friday.core.registry.ToolRegistry.keys",
    ...
    def test_registry_show_handles_error_during_import(self) -> None:
        ...
        with patch.dict("sys.modules", {"friday.core.registry": None}):
