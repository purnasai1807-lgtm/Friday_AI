"""Tests for context injection integration in ``friday ask``."""
...
def test_get_memory_backend_returns_backend_even_when_empty(
    ...
    failures downstream.
    """
    from friday.core.config import FridayConfig, MemoryConfig
    ...
    mod = importlib.import_module("friday.cli.ask")
