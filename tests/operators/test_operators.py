...
class TestOperativeAgent:
    def test_init_defaults(self):
        ...
        engine = FakeEngine()
        with patch(
            "friday.agents._stubs.load_config",
...
class TestSystemAskPassthrough:
    def test_system_prompt_forwarded(self):
        ...
        from friday.system import QueryOrchestrator

        with patch.object(QueryOrchestrator, "_run_agent", patched_run_agent):
            real_system = FridaySystem(
...
class TestOperatorsConfig:
    def test_config_defaults(self):
        from friday.core.config import OperatorsConfig
    ...
    def test_config_in_friday_config(self):
        from friday.core.config import FridayConfig
...
class TestLoadBundledOperators:
    ...
    def operators_dir(self):
        ...
        ops_dir = project_root / "src" / "friday" / "operators" / "data"
