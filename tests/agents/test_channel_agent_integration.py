...
from friday.agents.channel_agent import ChannelAgent
...
from friday.connectors._stubs import Document
...
def test_quick_query_inline_response(tmp_path: Path) -> None:
    ...
    containing calendar info and NO friday:// link.
    """
    ...
    assert "friday://" not in sent_content, (
