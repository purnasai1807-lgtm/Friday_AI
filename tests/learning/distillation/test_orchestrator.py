...
def _make_diagnosis_result():
    from friday.learning.distillation.diagnose.runner import DiagnosisResult
...
class TestDistillationOrchestrator:
    def test_full_session_completes(self, tmp_path: Path) -> None:
        from friday.learning.distillation.orchestrator import (
        ...
        with patch(
            "friday.learning.distillation.orchestrator.DiagnosisRunner"
        ) as MockDiag:
