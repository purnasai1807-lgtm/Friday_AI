"""Tests for friday.learning.distillation.triggers module."""
...
class TestUserFlagTrigger:
    def test_constructs_with_trace_id(self) -> None:
        from friday.learning.distillation.triggers import UserFlagTrigger
...
class TestScheduledTrigger:
    def test_constructs(self) -> None:
        from friday.learning.distillation.triggers import ScheduledTrigger
...
class TestClusterTrigger:
    def test_constructs(self) -> None:
        from friday.learning.distillation.triggers import ClusterTrigger
