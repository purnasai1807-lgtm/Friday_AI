"""Tests for friday.learning.distillation.models module."""
...
class TestEditPillar:
    ...
    def test_has_four_pillars(self) -> None:
        from friday.learning.distillation.models import EditPillar
...
class TestEditRiskTier:
    ...
    def test_has_three_tiers(self) -> None:
        from friday.learning.distillation.models import EditRiskTier
...
class TestEditOp:
    ...
    def test_intelligence_ops(self) -> None:
        from friday.learning.distillation.models import EditOp
...
class TestTriggerKind:
    ...
    def test_four_trigger_kinds(self) -> None:
        from friday.learning.distillation.models import TriggerKind
...
class TestSessionStatus:
    ...
    def test_all_statuses(self) -> None:
        from friday.learning.distillation.models import SessionStatus
...
class TestEdit:
    ...
    def _valid_edit_kwargs(self) -> dict:
        from friday.learning.distillation.models import (
            EditOp,
            EditPillar,
            EditRiskTier,
        )
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from friday.learning.distillation.models import Edit
...
class TestFailureCluster:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from friday.learning.distillation.models import FailureCluster
...
class TestLearningPlan:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from friday.learning.distillation.models import LearningPlan
...
class TestBenchmarkSnapshot:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from friday.learning.distillation.models import BenchmarkSnapshot
...
class TestEditOutcome:
    ...
    def test_applied_outcome(self) -> None:
        from friday.learning.distillation.models import EditOutcome
...
class TestLearningSession:
    ...
    def test_constructs_with_valid_fields(self) -> None:
        from friday.learning.distillation.models import LearningSession
