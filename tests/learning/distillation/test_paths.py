"""Tests for friday.learning.distillation.storage.paths module."""
...
class TestResolveDistillationRoot:
    ...
    def test_default_is_under_home(self, monkeypatch: pytest.MonkeyPatch) -> None:
        ...
        assert result == Path.home() / ".friday" / "learning"

    def test_respects_friday_home_env_var(
        self,
        tmp_path: Path,
    ...
    def test_rejects_path_inside_source_tree(
        ...
        # Find the Friday source root by walking up from the paths module.
