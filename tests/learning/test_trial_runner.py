"""Tests for friday.optimize.trial_runner module."""

from __future__ import annotations

from unittest.mock import MagicMock, patch

from friday.evals.core.types import RunConfig, RunSummary
from friday.learning.optimize.trial_runner import TrialRunner
from friday.learning.optimize.types import TrialConfig, TrialResult
...
class TestBuildRunConfig:
    ...
    def test_agent_maps_to_agent_backend(self) -> None:
        ...
        assert cfg.backend == "friday-agent"
    ...
    def test_no_agent_maps_to_direct_backend(self) -> None:
        ...
        assert cfg.backend == "friday-direct"
...
class TestRunTrial:
    ...
    @patch("friday.evals.cli._build_scorer")
    @patch("friday.evals.cli._build_judge_backend")
    @patch("friday.evals.cli._build_dataset")
    @patch("friday.evals.cli._build_backend")
    @patch("friday.evals.core.runner.EvalRunner")
    ...
    def test_run_trial_populates_sample_scores(
        ...
        from friday.evals.core.types import EvalResult
