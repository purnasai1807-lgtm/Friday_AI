...
from friday.core.events import (  # noqa: E402
    EventBus,
    EventType,
)
from friday.core.registry import MemoryRegistry  # noqa: E402
from friday.tools.storage._stubs import RetrievalResult  # noqa: E402
from friday.tools.storage.embeddings import Embedder  # noqa: E402
from friday.tools.storage.faiss_backend import (  # noqa: E402
    FAISSMemory,
)
...
def test_event_bus_store():
    ...
    import friday.tools.storage.faiss_backend as mod
