...
_PATCH_HTTP = "friday.mcp.transport.StreamableHTTPTransport"
_PATCH_STDIO = "friday.mcp.transport.StdioTransport"
_PATCH_CLIENT = "friday.mcp.client.MCPClient"
_PATCH_PROVIDER = "friday.tools.mcp_adapter.MCPToolProvider"
_PATCH_LOGGER = "friday.system.builder.logger"
