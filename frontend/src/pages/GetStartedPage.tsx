...
const GITHUB_BASE =
  'https://github.com/purnasai1807-lgtm/Friday_AI/releases/latest/download';
    ...
    <>
      ...
      <div className="flex flex-col gap-3 mb-10">
        <Section icon={Terminal} title="Command Line (macOS / Linux)" defaultOpen>
          ...
          <CodeBlock code={"git clone https://github.com/purnasai1807-lgtm/Friday_AI.git\ncd Friday_AI\nuv sync"} />
          <p className="text-xs mt-1" style={{ color: 'var(--color-text-secondary)' }}>
            Then get started:
          </p>
          <CodeBlock code={"friday init\nfriday doctor\nfriday chat"} />
        </Section>
