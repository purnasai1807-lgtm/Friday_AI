...
const CONVERSATIONS_KEY = 'friday-conversations';
const SETTINGS_KEY = 'friday-settings';
const OPTIN_KEY = 'friday-optin';
const OPTIN_NAME_KEY = 'friday-display-name';
const OPTIN_EMAIL_KEY = 'friday-email';
const OPTIN_ANONID_KEY = 'friday-anon-id';
const OPTIN_SEEN_KEY = 'friday-optin-seen';
