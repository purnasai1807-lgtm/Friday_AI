...
const CLOUD_PROVIDERS: CloudProvider[] = [
  ...
  },
  {
    ...
    storageKey: 'friday-anthropic-key',
    models: [
  ...
  },
  {
    ...
    storageKey: 'friday-openrouter-key',
    models: [
      ...
      >
        ...
        >
          {tab === 'installed' ? (
            ...
            <span>API keys are stored locally and never sent to Friday servers</span>
          )}
        </div>
      </div>
    </div>
