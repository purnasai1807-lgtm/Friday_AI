...
const OPTIN_KEY = 'friday-desktop-optin';
const OPTIN_NAME_KEY = 'friday-desktop-display-name';
const OPTIN_EMAIL_KEY = 'friday-desktop-email';
const OPTIN_ANONID_KEY = 'friday-desktop-anon-id';
    ...
    <div style={styles.container}>
      ...
      {showOptIn ? (
        ...
        <div style={{ marginBottom: 16, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <a
            href="https://purnasai1807-lgtm.github.io/Friday_AI/leaderboard"
            target="_blank"
